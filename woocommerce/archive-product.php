    ...
    <section class="archiveShop__content">
        ...
        <section class="archiveNotfound">
            ...
            <div class="archiveNotfound__wrap">
                <h3 class="sectionHeading"><span>Niestety nie znaleziono produktów</span></h3>
                <a href="<?php echo home_url('/produkty'); ?>" class="btn btn--blue"><span>Powrót do sklepu</span></a>
            </div>
