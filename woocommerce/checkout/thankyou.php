	...
	if ( $order ) :
		...
		<?php else : ?>
            ...
            <section class="loloTYP__heading">
                <div class="wrap">
                    <h2 class="sectionHeading"><span>Gratulacje!</span></h2>
                    <h4>Udało Ci się pomyślnie złożyć zamówienie!</h4>
                    <p class="content"> Dziękujemy za zakupy w naszym sklepie. Dokładamy wszelkich starań, aby twoje zamówienie dotarło na wskazany adres jak najszybciej. Wkrótce otrzymasz maila ze szczegółami zamówienia.</p>
                    <a href="<?php echo home_url(); ?>" class="btn"><span>Wróć do sklepu</span></a>
                </div>
            </section>
            ...
            <svg class="wave wave--top" xmlns="http://www.w3.org/2000/svg" width="5469" height="34" viewBox="0 0 5469 34" fill="none">
                ...
                <div class="wrap">
                    <h2 class="sectionHeading"><span>Oceń nas!</span></h2>
                    <p>Jak oceniasz dzisiejsze doświadczenie podczas zakupów z Lolobaby?</p>
