...
<div id="page" class="site">
	...
	<header id="masthead" class="siteHeader<?php if(is_front_page() || is_singular()): ?> siteHeader--frontPage<?php endif; ?>">
		<div class="siteHeader__wrap container">
			...
			<div class="siteHeader__logo">
				<a href="<?php echo home_url(); ?>" class="wrap<?php if(is_singular()): ?> wrap--transparent<?php endif; ?>">
