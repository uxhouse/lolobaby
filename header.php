...
<div id="page" class="site">
	...
	<header id="masthead" class="siteHeader<?php if(is_front_page() || is_single()): ?> siteHeader--frontPage<?php endif; ?>">
		<div class="siteHeader__wrap container">
			...
			<div class="siteHeader__logo">
				<a href="<?php echo home_url(); ?>" class="wrap<?php if(is_single()): ?> wrap--transparent<?php endif; ?>">
